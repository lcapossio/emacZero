...
EOF-sideband FIFO cleanup, XPM FIFO advanced-feature trim, and 13-bit TX FIFO
count fix.

| Test | Conditions | Result |
|------|------------|--------|
| UART/CSR/ARP/ICMP smoke | `serial_monitor.py`, default ICMP count | PASS, `VER=0001454D`, ICMP `20/20` |
| UDP echo | 10 s, host target 50 Mbps on UDP/9999 | PASS, 40637/40637 echoes, 47.85 Mbps, 0.00% loss |
...
| Bidirectional long | 60 s, host target 99 Mbps, FPGA IFG 8000 cycles | PASS, FPGA->host 95.14 Mbps, host->FPGA 95.73 Mbps, 29 FPGA->host gaps, 0 host->FPGA gaps |
